...
public class PedidoDAO {
	...
	public static Pedido loadPedidoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Pedido) session.load(trustpet.Pedido.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pedido getPedidoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Pedido) session.get(trustpet.Pedido.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pedido loadPedidoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Pedido) session.load(trustpet.Pedido.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Pedido getPedidoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Pedido) session.get(trustpet.Pedido.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryPedido(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From trustpet.Pedido as Pedido");
		if (condition != null)
	...
	public static Pedido createPedido() {
		return new trustpet.Pedido();
	}
	
	public static boolean save(trustpet.Pedido pedido) throws PersistentException {
		try {
	...
	public static boolean delete(trustpet.Pedido pedido) throws PersistentException {
		try {
	...
	public static boolean refresh(trustpet.Pedido pedido) throws PersistentException {
		try {
	...
	public static boolean evict(trustpet.Pedido pedido) throws PersistentException {
		try {
