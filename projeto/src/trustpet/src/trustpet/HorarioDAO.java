...
public class HorarioDAO {
	...
	public static boolean save(trustpet.Horario horario) throws PersistentException {
		try {
			ClassPersistentManager.instance().saveObject(horario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(trustpet.Horario horario) throws PersistentException {
		try {
			ClassPersistentManager.instance().deleteObject(horario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(trustpet.Horario horario) throws PersistentException {
		try {
			ClassPersistentManager.instance().getSession().refresh(horario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(trustpet.Horario horario) throws PersistentException {
		try {
			ClassPersistentManager.instance().getSession().evict(horario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
