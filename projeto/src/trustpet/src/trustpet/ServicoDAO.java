...
public class ServicoDAO {
	...
	public static Servico loadServicoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Servico) session.load(trustpet.Servico.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Servico getServicoByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Servico) session.get(trustpet.Servico.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Servico loadServicoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Servico) session.load(trustpet.Servico.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Servico getServicoByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Servico) session.get(trustpet.Servico.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryServico(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From trustpet.Servico as Servico");
		if (condition != null)
	...
	public static Servico createServico() {
		return new trustpet.Servico();
	}
	
	public static boolean save(trustpet.Servico servico) throws PersistentException {
		try {
			ClassPersistentManager.instance().saveObject(servico);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(trustpet.Servico servico) throws PersistentException {
		try {
			ClassPersistentManager.instance().deleteObject(servico);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(trustpet.Servico servico) throws PersistentException {
		try {
			ClassPersistentManager.instance().getSession().refresh(servico);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(trustpet.Servico servico) throws PersistentException {
		try {
			ClassPersistentManager.instance().getSession().evict(servico);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
